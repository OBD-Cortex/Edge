...
def main():
    ...
    parser.add_argument("--vin", default="LZWADAGA2JE924229", help="VIN to decode and pair the device with")
    ...
    # 2. Decode VIN via local offline decoder
    print("\n[*] Step 1: Querying vehicle details using local VIN decoder...")
    vin_data = decode_vin(args.vin)
    brand = vin_data.get("brand", "Unknown")
    ...
    try:
        ...
        if result == "REPROVISION_REQUIRED":
            ...
            print("        Run this script again with --force-provision")
            sys.exit(1)
